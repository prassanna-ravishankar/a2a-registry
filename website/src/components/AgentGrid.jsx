...
const AgentGrid = ({
    ...
    return (
        <div className="flex-1 bg-black overflow-y-auto overflow-x-hidden custom-scrollbar relative">
            ...
            <div className="relative p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 w-full">
