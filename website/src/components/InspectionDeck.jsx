...
const InspectionDeck = ({ agent, onClose }) => {
    if (!agent) {
        return (
            <aside className="w-[450px] border-l border-zinc-800 bg-zinc-950 flex flex-col items-center justify-center text-zinc-700 shrink-0">
    ...
    return (
        <aside className="w-[450px] border-l border-zinc-800 bg-zinc-950 flex flex-col shrink-0">
            {/* Header */}
